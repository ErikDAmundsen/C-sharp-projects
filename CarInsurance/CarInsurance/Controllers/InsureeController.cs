...
namespace CarInsurance.Controllers
{
    public class InsureeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult QuoteTotal(string firstName, string lastName, string emailAddress, DateTime dob, int carYear, string carMake, string carModel, bool dui, int numberoftickets, bool fullcoverage )
        {
